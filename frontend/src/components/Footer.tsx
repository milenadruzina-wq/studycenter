...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white mt-auto relative overflow-hidden" role="contentinfo">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-gray-400">
                ...
                <span>+996500318269</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
                <MapPin className="w-4 h-4" aria-hidden="true" />
                <span>город Шопоков, улица Мира 13</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400">
                ...
                <a 
                  href="https://www.instagram.com/i_love_englishschool" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  @i_love_englishschool
                </a>
              </div>
            </div>
          </motion.div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Study Center. {t('footer.rights')}.</p>
        </div>
      </div>
    </footer>
  );
